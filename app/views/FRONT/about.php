        ...
        <article>
            ...
            <div>     
                ...
                <p class="cormorant_p story">Ayant été fâchée avec l’anglais durant toute ma scolarité, il a fallu que je m’expatrie dans 
                    ...
                    mon anglais était quasi inexistant !</p>
                <p class="cormorant_p story">Ne croyez pas que le fait d’aller dans un pays anglophone vous donnera un 
                    superbe anglais : j’ai rencontré à Londres nombre de personnes y ayant vécu de longues 
                    années et dont l’anglais était plus que basique ! Le risque étant de ne fréquenter que
                    des francophones, qui sont relativement nombreux outre-Manche (ne dit-on pas de Londres
                    qu’elle est la « sixième » ville de France).</p>
                <p class="cormorant_p story">Ainsi, j’ai appris sur le tas en combinant travail et apprentissage,
                    avec une méthodologie qui m’était propre et me convenait. Je suis ensuite allée en Australie
                ...
                <p class="cormorant_p story">J'ai ensuite été traductrice tout en donnant des cours 
                    ...
                    à des avocats, des ingénieurs de polytechnique et des artistes des beaux-arts) pendant 
                    sept ans, conjointement à mes activités de traductrice. Je collabore désormais avec la 
                ...
                <p class="cormorant_p story">Lorsque je suis partie au début des années 2000, Internet 
                    était très limité et c’était tout de même bien plus facile pour s’imprégner de l’accent, 
                    la prononciation et la culture anglaise d’aller faire un petit séjour outre-Manche. Mais 
                    de nos jours, grâce aux nombreuses ressources en ligne, on peut s’immerger en restant chez 
                    soi. Lors de la formation, qui est très ludique et vivante, outre l’enseignement de 
                    l’anglais, je vous expliquerai comment continuer votre apprentissage en ayant recours à des 
                    ressources basées sur des choses que vous aimez.</p>
